...
exports.reli_check = function (req, res, next) {
   ...
   if(reli_info=='All')
   {
      ...
      db.query(sql, function (err, data1) {
         ...
         db.query(sql, function (err, data) {
            res.render('reli_page.ejs', { userData: data, userData1: data1, userData3: data3, userData4: data4, userData5: data5, message: message });
         });
      });
      });
   });
...
exports.mbbs_board = function (req, res, next) {
   ...
   db.query(sql, function (err, data1) {
      var sql = "SELECT * FROM `ems`.`cand_admission_details`;"
      db.query(sql, function (err, data) {
         res.render('mbbs_viewstudent.ejs', { userData: data, userData1: data1, userData3: data3, userData4: data4, userData5: data5, userData9: data9,message: message });
      });
   });
});
   });
